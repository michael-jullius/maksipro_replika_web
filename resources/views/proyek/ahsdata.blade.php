            ...
            <nav class="navbar navbar-light bg-light w-100 d-flex">
                <form class="form-inline mr-auto d-flex">
                    <select name="filter" class="form-control mr-2">
                        ...
                        <option value="analisa_pekerjaan">analisa pekerjaan</option>
                ...
                <div class="dropdown mr-3">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background: #DCDCDC;">
                        <a href="{{ route('exportExcelAhsData', $id_proyek) }}" class="btn btn-success" style="margin:10px; width: 200px;"><i class="bi bi-file-earmark-spreadsheet mr-2"></i>Export Excel</a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuAdd" style="background: #DCDCDC;">
                        ...
                        <a href="{{ route('viewAddAhsData', $id_proyek) }}" style="margin:10px; width: 200px;" class="btn btn-primary">+ Tambah Manual</a>
                    </div>
                </div>
                <a href="{{ route('deleteAllAhsData', $id_proyek) }}" class="btn btn-danger ml-3"><i class="bi bi-trash mr-2"></i>Delete All</a>
            </nav>
        </div>
        <div class="card-body">
            <table class="table mt-5">
                ...
                <tr>
                    ...
                    <td>{{ $value->satuan }}</td>
                    <td class="d-flex">
                        <a class="btn btn-warning mr-2" href="{{ route('viewEditAhsData', [$id_proyek, $value->id]) }}" ><b>Ubah</b></a>
                        <a class="btn btn-danger ml-2" href="{{ route('deleteAhsData', [$id_proyek, $value->id]) }}" ><b>Hapus</b></a>
                    </td>
                </tr>
                @endforeach
            </table>
...
<div class="modal fade" id="ImportExcel" tabindex="-1" role="dialog" aria-labelledby="ImportExel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form" method="post" enctype="multipart/form-data" action="{{ route('importExcelAhsData', $id_proyek) }}">
            @csrf 
